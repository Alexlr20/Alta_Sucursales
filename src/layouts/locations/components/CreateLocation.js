...
export default function LocationForm({ handleShowAdd }) {
  ...
  const handleSubmit = () => {
    ...
    cleanedUpHistory = {...cleanedUpHistory.map(el => ({
  ...
  const handleUpdateDay = () => {
    ...
    const newState = historyState.map((e, i, arr) => {
      ...
      // console.log('Element in history - Dia)', typeof e);
      console.log('Object in history', e);
      // let currentIdFromObject = e[0].scheduleId ? e.scheduleId;
    ...
    // if (savedDaysArr.findIndex((e) => e.includes("Domingo")) !== -1){
    //   daysHistory.sunday = true;
    // } else {
    //   daysHistory.sunday = false;
    // }

    // if (savedDaysArr.findIndex((e) => e.includes("Lunes")) !== -1){
    //   daysHistory.monday = true;
    // } else {
    //   daysHistory.monday = false;
    // }

    // if (savedDaysArr.findIndex((e) => e.includes("Martes")) !== -1){
    //   daysHistory.tuesday = true;
    // } else {
    //   daysHistory.tuesday = false;
    // }

    // if (savedDaysArr.findIndex((e) => e.includes("Miercoles")) !== -1){
    //   daysHistory.wednesday = true;
    // } else {
    //   daysHistory.wednesday = false;
    // }

    // if (savedDaysArr.findIndex((e) => e.includes("Jueves")) !== -1){
    //   daysHistory.thursday = true;
    // } else {
    //   daysHistory.thursday = false;
    // }

    // if (savedDaysArr.findIndex((e) => e.includes("Viernes")) !== -1){
    //   daysHistory.friday = true;
    // } else {
    //   daysHistory.friday = false;
    // }

    // if (savedDaysArr.findIndex((e) => e.includes("Sábado")) !== -1){
    //   daysHistory.saturday = true;
    // } else {
    //   daysHistory.saturday = false;
    // }

    // if (savedDaysArr.findIndex((e) => e.includes("Todos")) !== -1){
    //   daysHistory.all = true;
    // } else {
    //   daysHistory.all = false;
    // }
